const styles = {
  ...
  heroSubheading:
      'font-light lg:text-[104px] md:text-[60px] sm:text-[40px] text-[34px] lg:leading-[108.4px] md:leading-[74.4px] sm:leading-[34.4px] leading-[24.4px] uppercase text-white',
  heroDText:
